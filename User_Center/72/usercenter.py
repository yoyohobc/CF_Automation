...
def creat_suite():
    ...
    discover = unittest.defaultTestLoader.discover(testcase_path, pattern="test_2_02*.py")
...
runner = HTMLTestRunner.HTMLTestRunner(stream=file_results, title=u"72 用戶中心 PC",description=u"  執行環境: " + ' ' + OS + ' ' + Browser + ' ' + ' browser version: ' + browser.capabilities['browserVersion'] + ' driver version:' + browser.capabilities['chrome']['chromedriverVersion'][:14], verbosity=2)
