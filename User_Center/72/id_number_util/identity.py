...
# 导入常量并重命名
import id_number_util.constant as const
...
'''if __name__ == '__main__':
    ...
    a=IdNumber.generate_id(random_sex)
    print(a)  # 随机生成身份证号
    print(IdNumber(a).area_id)  # 地址编码:410326
    print(IdNumber(a).get_area_name())  # 地址:河南省洛阳市汝阳县
    print(IdNumber(a).get_birthday())  # 生日:1995-7-10
    print(IdNumber(a).get_age())  # 年龄:23(岁)
    print(IdNumber(a).get_sex())  # 性别:1(男)
    print(IdNumber(a).get_check_digit())  # 校验码:7
    print(IdNumber.verify_id(a))  # 检验身份证是否正确:False'''
